...
jit.nodeModules = function (dir, test) {
  var newModsDir = path.resolve(dir);
  if (test || fs.existsSync(newModsDir)) {
    MODULES_ROOT = newModsDir;
  } else {
    jit.grunt.log.writeln('jit-grunt: changed node_modules dir not exist ('.yellow + dir.cyan + ') '.yellow);
  }
};
